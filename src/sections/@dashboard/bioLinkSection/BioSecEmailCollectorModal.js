...
export default function BioSecEmailCollectorModal({ bioSecEmailCollectorModalState, closeBlockSubModal }) {
    ...
    return (
        <div>
            <Modal
                open={bioSecEmailCollectorModalState}
                onClose={() => closeBlockSubModal('bioSecEmailCollectorModalState')}
            ...
            >
                <EmailModalMain>
                    <EmailSubHeader>
                        ...
                        <CloseIcon onClick={() => closeBlockSubModal('bioSecEmailCollectorModalState')} sx={{ cursor: 'pointer' }} />
                    </EmailSubHeader>
                    <Typography variant="body1" sx={{ mt: 2, color: 'text.disabled' }}>
                        Capture email sign ups with ease.
                    </Typography>
