...
export default function VCardLinkModal({ cardModal, closeModal }) {
  return (
    <Modal
      open={cardModal}
      onClose={()=>closeModal('cardModal')}
    ...
    >
      <Stack sx={style}>
        <Box sx={{ position: 'relative' }}>
          ...
          <IconButton fontSize="small" sx={{ position: 'absolute', top: '-5px', right: '0px' }} onClick={()=>closeModal('cardModal')}>
